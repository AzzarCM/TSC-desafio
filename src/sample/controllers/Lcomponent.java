...
public class Lcomponent implements Initializable{
    public void backTo(javafx.event.ActionEvent actionEvent) throws IOException {
        Parent screenParent = FXMLLoader.load(getClass().getResource("/sample/views/m2component.fxml"));
    ...
    public void initialize(URL url, ResourceBundle resourceBundle) {
        ...
        path.getElements().add(new LineTo(375 , 300));
